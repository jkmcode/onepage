...
function PrivacyPolicy() {
  ...
  return (
    <Container className="public-policy-position">
      <h2>{t("PrivatePolicy_title")}</h2>
      <h2>{t("PrivatePolicy_1_General_Information")}</h2>
      <ul>
      ...
      <h2>{t("PrivatePolicy_2_Selected_data_protection")}</h2>
      <ul>
      ...
      <h2>{t("PrivatePolicy_3_Hosting")}</h2>
      <ul>
        <li>{t("PrivatePolicy_3.1_Hosting")}</li>
      </ul>
      <h2>{t("PrivatePolicy_4_Rights_and_additional_information")}</h2>
      <ul>
        <li>{t("PrivatePolicy_4.1_Rights_and_additional_information")}</li>
        <ul>
          <li>{t("PrivatePolicy_4.1.1_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.1.2_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.1.3_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.1.4_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.1.5_Rights_and_additional_information")}</li>
        </ul>
        <li>{t("PrivatePolicy_4.2_Rights_and_additional_information")}</li>
        <li>{t("PrivatePolicy_4.3_Rights_and_additional_information")}</li>
        <ul>
          <li>{t("PrivatePolicy_4.3.1_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.3.2_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.3.3_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.3.4_Rights_and_additional_information")}</li>
          <li>{t("PrivatePolicy_4.3.5_Rights_and_additional_information")}</li>
        </ul>
      ...
      <h2>{t("PrivatePolicy_5_Information_in_the_forms")}</h2>
      <ul>
      ...
      <h2>{t("PrivatePolicy_6_Administrator_logs")}</h2>
      <ul>
        <li>{t("PrivatePolicy_6.1_Administrator_logs")}</li>
      </ul>
      <h2>{t("PrivatePolicy_7_Relevant_marketing_techniques")}</h2>
      <ul>
        <li>{t("PrivatePolicy_7.1_Relevant_marketing_techniques")}</li>
      </ul>
      <h2>{t("PrivatePolicy_8_Information_about_cookies")}</h2>
      <ul>
      ...
      <h2>{t("PrivatePolicy_9_Managing cookies")}</h2>
      <ul>
      ...
      <p>{t("PrivatePolicy_conclusion")}</p>
    </Container>
  );
}
